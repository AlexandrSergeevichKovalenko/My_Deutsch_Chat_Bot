...
async def generate_sentences():
    ...
    prompt = """
    Ты — генератор русских предложений для изучения немецкого языка.
    Сгенерируй 7 осмысленных, грамматически правильных предложений **на русском языке** для перевода на **немецкий**.
    
    **Требования:**
    - Уровень сложности предложений B2-C1
    ...
    - **Без перевода. Только русские предложения.**
    - Лексика должна быть **частоупотребительной в повседневной жизни** (бизнес, медицина, хобби, свободное время, учёба, работа, путешествия).
